defmodule ExampleWeb.FlowPipelineLive do
  @moduledoc """
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     assign(socket,
       ...
       flow: flow,
       node_types: %{
         start: ExampleWeb.FlowPipeline.StartNode,
         http: ExampleWeb.FlowPipeline.HttpNode,
         transform: ExampleWeb.FlowPipeline.TransformNode,
         condition: ExampleWeb.FlowPipeline.ConditionNode,
         delay: ExampleWeb.FlowPipeline.DelayNode,
         log: ExampleWeb.FlowPipeline.LogNode
       },
